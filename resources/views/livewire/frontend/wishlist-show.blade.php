            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="shopping-cart">
                        ...
                        @forelse ($wishlistShow as $wishlistItem)
                        @if($wishlistItem->product)

                        <div class="cart-item">
                            <div class="row">
                                <div class="col-md-6 my-auto">
                                    <a href="{{ route('frontend.product.view', [$wishlistItem->product->category->slug, $wishlistItem->product->slug]) }}">
                                        <label class="product-name">
                                            <img src="{{ Storage::url($wishlistItem->product->productImages[0]->image) }}" style="width: 50px; height: 50px" alt="{{ $wishlistItem->product->name }}">
