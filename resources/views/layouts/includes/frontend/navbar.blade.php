            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-5 my-auto">
                        <form role="search" action="{{route('frontend.searchProducts')}}" method="GET">
                            @csrf
                    ...
                    <div class="col-md-5 my-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li><a class="dropdown-item" href="{{ route('frontend.profile') }}"><i class="fa fa-user"></i> Profile</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('frontend.newArrival') }}">New Arrivals</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('frontend.featuredProducts') }}">Featured Products</a>
                        </li>
                        <li class="nav-item">
