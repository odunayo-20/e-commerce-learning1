        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="footer-underline"></div>
                    <div class="mb-2"><a href="{{ route('frontend.categories') }}" class="text-white">Collections</a></div>
                    <div class="mb-2"><a href="{{ route('index') }}" class="text-white">Trending Products</a></div>
                    <div class="mb-2"><a href="{{ route('frontend.newArrival') }}" class="text-white">New Arrivals Products</a></div>
                    <div class="mb-2"><a href="{{ route('frontend.featuredProducts') }}" class="text-white">Featured Products</a></div>
